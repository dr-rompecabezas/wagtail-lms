...
This is a minimal Wagtail project configured to demonstrate wagtail-lms.
For production use, refer to Django's deployment checklist.
"""
...
INSTALLED_APPS = [
    "home",
    "search",
    # Wagtail LMS - the package we're testing
    "wagtail_lms",
    # Wagtail apps
...
STATIC_ROOT = os.path.join(BASE_DIR, "example_project", "static_collected")
STATIC_URL = "/static/"
...
WAGTAIL_SITE_NAME = "Wagtail LMS Example"
